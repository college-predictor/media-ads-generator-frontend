  ...
  return (
    ...
    <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-8 bg-gray-100">
        ...
        <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-4">Ad Generator</h1>
            
            <p className="text-gray-600 text-sm leading-relaxed">
            Login to access your Ad Generator account
            </p>
        </div>
        </div>
    </div>
    ...
    <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        ...
        <div>
            ...
            <p className="text-gray-600 mb-8">Login to access your Ad Generator account</p>
